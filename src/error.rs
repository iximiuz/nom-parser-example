...
///
/// ```
/// # use nom_parser_example::error::{identifier, Span};
/// #
/// # fn main() {
...
///
/// ```
/// # use nom_parser_example::error::{string_literal, Span};
/// #
/// # fn main() {
...
///
/// ```
/// # use nom_parser_example::error::{match_op, MatchOp, Span};
/// #
/// # fn main() {
...
///
/// ```
/// # use nom_parser_example::error::{label_match, LabelMatch, MatchOp, Span};
/// #
/// # fn main() {
...
///
/// ```
/// # use nom_parser_example::error::{vector_selector, Span};
/// #
/// # fn main() {
